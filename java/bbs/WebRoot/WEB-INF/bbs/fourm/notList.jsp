    ...
    <ul class="nav navbar-nav navbar-right">
        <!--登录注册-->
            ...
            <li class="dropdown">
                    ...
                    <img src="./帖子_files/58622000600d7-4d971fd3_64_64.jpg" class="navbar-avatar-img">
                </a>
...
<div class="friend_panel visible-md visible-lg" style="display: none">
        ...
        <div id="right_panel_main" style="display: none">
            ...
            <script>
                ...
                var last_toast_talk_message_time="1483693102";//最后提示会话消息的时间
            </script>
            <!--结束会话版-->
        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <a target="_blank" title=" a542913513" href="http://localhost/bbs_/index.php?s=/UserCenter/Index/index/uid/6.html">
                                            <img src="./帖子_files/default_64_64.jpg" class="avatar-img" style="width: 45px;">
                                        </a>
                                    </div>
                                    <div class="col-md-6">
                                        <div>
    ...
    <div id="chat_box" style="display: none" class="chat_panel">
        <div class="panel_title"><img id="chat_ico" class="chat_avatar avatar-img" src="./帖子_files/default_64_64.jpg">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-4 col-sm-2">
                <img class="hidden-xs" src="./帖子_files/header-rabbit.png">
                <img class="visible-xs" style="width: 100px;padding-top: 32px;" src="./帖子_files/header-rabbit.png">
            </div>
...
<script type="text/javascript" src="./帖子_files/jquery.magnific-popup.min.js.下载"></script>
<link type="text/css" rel="stylesheet" href="./帖子_files/magnific-popup.css">
    <div class="row">
    <div class="col-xs-12 boxShadow" style="background: white">
        ...
        <div class="row" style="position: relative">
                ...
                <div class="col-xs-2">
                    <p>
                        <a href="http://localhost/bbs_/index.php?s=/UserCenter/Index/index/uid/5.html" ucard="5" data-hasqtip="0" aria-describedby="qtip-0"><img src="./帖子_files/58622000600d7-4d971fd3_128_128.jpg" class="avatar-img"></a>
                    </p>
                    ...
                    <p class="text-center">
                        <img src="./帖子_files/586618cfc553f.jpg" title="白丁" alt="白丁" class="rank_html">                       </p>
                </div>
...
<script>
    bindSupport();
        ...
        <!--发表回复-->
                ...
                <div class="col-xs-2">
                    <p>
                        <a href="http://localhost/bbs_/index.php?s=/Forum/Index/detail/id/33.html" ucard="" data-hasqtip="2"><img src="./帖子_files/58622000600d7-4d971fd3_128_128.jpg" class="avatar-img"></a>
                    </p>
                </div>
                <div class="col-xs-10">
                    <div id="reply_block">
                        <form id="reply_form" action="http://localhost/bbs_/index.php?s=/Forum/Index/doReply/post_id/33.html" method="post" class="ajax-form">
                            ...
                            <p>
                                ...
                                <link href="./帖子_files/umeditor.min.css" type="text/css" rel="stylesheet">

<script type="text/javascript" charset="utf-8" src="./帖子_files/umeditor.config.js.下载"></script>

<script type="text/javascript" charset="utf-8" src="./帖子_files/umeditor.min.js.下载"></script>
<script type="text/javascript" charset="utf-8" src="./帖子_files/zh-cn.js.下载"></script>
...
<script>
    ...
    <script type="text/javascript" src="./帖子_files/atwho.js.下载"></script>
    <link type="text/css" rel="stylesheet" href="./帖子_files/atwho.css">
    <script>
...
<link rel="stylesheet" type="text/css" href="./帖子_files/check.css">
...
<script type="text/javascript" src="./帖子_files/placeholder.js.下载"></script>
        <script>
            $(function(){
...
<div id="atwho-container"><div id="atwho-ground-contentEditor"><div class="atwho-view" id="at-view-at"><ul class="atwho-view-ul"></ul></div></div></div><div id="qtip-0" class="qtip qtip-default qtip-bootstrap qtip-pos-tl qtip-focus" tracking="false" role="alert" aria-live="polite" aria-atomic="false" aria-describedby="qtip-0-content" aria-hidden="false" data-qtip-id="0" style="z-index: 15001; top: 486px; left: 501.5px; display: block;"><div class="qtip-tip" style="background-color: transparent !important; border: 0px !important; width: 8px; height: 8px; line-height: 8px; left: 5px; top: -8px;"><canvas width="8" height="8" style="background-color: transparent !important; border: 0px !important; width: 8px; height: 8px;"></canvas></div><div class="qtip-titlebar"><div id="qtip-0-title" class="qtip-title" aria-atomic="true"><b><a href="http://localhost/bbs_/index.php?s=/UserCenter/Index/index/uid/5.html">123456</a></b>的小名片</div></div><div class="qtip-content" id="qtip-0-content" aria-atomic="true"><p>等级：Lv2 试用</p><p>头衔：<img src="./帖子_files/586618cfc553f.jpg" title="白丁" alt="白丁" style="width: 18px;height: 18px;vertical-align: middle;margin-left: 2px;"></p><p>积分：59</p><div style="width: 200px" class="progress progress-striped active"><div class="progress-bar" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 59%"><span class="sr-only">59%</span></div></div><p style="width: 217px;">微博：4&nbsp;&nbsp;粉丝：1&nbsp;&nbsp;关注：2</p><p>个性签名：还没想好O(∩_∩)O</p></div></div></body></html>